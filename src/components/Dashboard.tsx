...
const Dashboard = () => {
  ...
  // Use the new GridDashboard for the main interface
  if (viewMode === 'grid') {
    return <GridDashboard viewMode={viewMode} onToggleView={toggleViewMode} />;
  }
  ...
  // Legacy list view (preserved for compatibility)
  return (
