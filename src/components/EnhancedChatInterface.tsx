...
const EnhancedChatInterface = ({ conversationId, projectId }: EnhancedChatInterfaceProps) => {
  ...
  const { sendMessage, isLoading: aiLoading } = useAIAssistant();
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Send to AI assistant with project context
      await sendMessage(userMessage, conversationId, codeFiles);
    } catch (error) {
        ...
        {messages && messages.length > 0 ? (
          ...
          <div className="flex items-center justify-center h-full">
            <div className="text-center">
              ...
              <h4 className="font-medium text-gray-900 mb-2">AI Coding Assistant</h4>
